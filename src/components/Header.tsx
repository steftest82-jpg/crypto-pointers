          ...
          <div className="flex items-center justify-between h-16 md:h-[72px]">
            ...
            >
              ...
              <div className="relative group">
                <button
                  className="flex items-center gap-1 px-3.5 py-2 text-[13px] font-semibold text-text/70 hover:text-primary rounded-lg hover:bg-primary/5 transition-all duration-200"
                  aria-expanded="false"
                  aria-haspopup="true"
                >
                  Categories
                  <svg
                    className="w-3.5 h-3.5 opacity-50 group-hover:opacity-100 transition-all duration-200 group-hover:rotate-180"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2.5}
                ...
                <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="w-52 bg-white rounded-xl shadow-elevated border border-accent/10 p-1.5">
                    {categories.map((cat) => (
                      <Link
                        key={cat.slug}
                        href={`/category/${cat.slug}`}
                        className="flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium text-text/70 hover:text-primary hover:bg-primary/5 rounded-lg transition-all duration-200"
                      >
